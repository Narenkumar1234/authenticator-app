 ...
 *   websites: string[],          // associated domains for autofill matching
 ...
 */
async function addAccount({ issuer, label, secret, type, algorithm, digits, period, counter, websites }) {
  const accounts = await getAccounts();
...
async function updateAccount(id, updates) {
  ...
  if (updates.websites !== undefined) accounts[idx].websites = updates.websites;
